    ...
    return (
      <div>
        ...
        <bottlereact.WatchButton
          prefetchedState={{watched: this.props.watched_by_user}}
        ...
        <npm.Tooltip group={this.key()} active={this.state.tooltipActive} position="top" arrow="center" parent={"#" + this.key()} tooltipTimeout={0}>
          <div>
            ...
            <a href={this.props.show_path} style={{cursor: "pointer", fontSize:'1.2em', marginRight: "26px"}}>{this.props.show_title}</a>
